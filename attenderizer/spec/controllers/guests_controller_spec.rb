  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guest as @guest" do
        post :create, {:guest => invalid_attributes}, valid_session
        expect(assigns(:guest)).to be_a_new(Guest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested guest" do
        guest = Guest.create! valid_attributes
        put :update, {:id => guest.to_param, :guest => new_attributes}, valid_session
        guest.reload
    ...
    describe "with invalid params" do
      it "assigns the guest as @guest" do
        guest = Guest.create! valid_attributes
        put :update, {:id => guest.to_param, :guest => invalid_attributes}, valid_session
        expect(assigns(:guest)).to eq(guest)
      end
